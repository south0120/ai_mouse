...
const I18N = {
  ja: {
    ...
    vocabRemoveBtn: "削除",
    vocabSync: "同期",
    vocabSyncTooltip: "クラウドと単語帳を双方向同期します（Pro+ / BYOK）",
    vocabSyncing: "同期中…",
    vocabSyncDone: "同期完了",
    vocabSyncFailed: "同期に失敗しました",
    vocabSyncProPlusOnly: "クラウド同期は Pro+ または BYOK プランのみ利用できます",
    vocabSyncLastAt: "最終同期",
    ...
    domainFinance: "金融",
    domainBusiness: "ビジネス",
    domainProPlusOnly: "専門分野は Pro+ プラン以上で利用できます。アップグレードで医学・法律・IT・金融・ビジネスの専門辞書がオンに",
    domainEnabled: "選択した分野の専門用語を優先して回答します",
    ...
    planProPlusPrice: "$5.99/月",
    planProPlusBenefits: "専門辞書・クラウド同期・優先サポート",
    planByokLimit: "自分のAPIキーを使用",
    planByokPrice: "$1.99/月",
  ...
  en: {
    ...
    vocabSync: "Sync",
    vocabSyncTooltip: "Two-way sync your vocabulary with the cloud (Pro+ / BYOK)",
    vocabSyncing: "Syncing…",
    vocabSyncDone: "Synced",
    vocabSyncFailed: "Sync failed",
    vocabSyncProPlusOnly: "Cloud sync is available on Pro+ or BYOK only",
    vocabSyncLastAt: "Last sync",
    outputLangSection: "Output Language",
    outputLangLabel: "AI response language",
    domainSection: "Domain dictionary",
    domainLabel: "Domain",
    ...
    domainProPlusOnly: "Domain dictionaries are available on Pro+ and above. Upgrade to enable medical/legal/tech/finance/business specialty modes.",
    domainEnabled: "Answers will prefer the selected domain's terminology.",
    ...
    planProPlusBenefits: "Domain dictionaries · Cloud sync · Priority support",
