...
const I18N = {
  ja: {
    ...
    historyFreeNote: "無料プランは10件まで保存できます。Proプラン以上で20〜50件に拡張できます。",
    historyPaidRequired: "20件以上はProプラン以上が必要です。プランをアップグレードしてください。",
    planModalTitle: "プランを選択",
    planSelectBtn: "選択",
    planFreeName: "無料",
    planFreeLimit: "1日10回まで",
    planFreePrice: "¥0/月",
    planProLimit: "月1,000クレジット",
    planProPrice: "¥480/月",
    planProBenefits: "履歴保存・優先サポート",
    planProPlusName: "Pro+ (推奨)",
    planProPlusLimit: "月3,000クレジット",
    planProPlusPrice: "¥798/月",
    planProPlusBenefits: "高速処理・優先サポート",
    planByokLimit: "自分のAPIキーを使用",
    planByokPrice: "¥165/月",
    planByokBenefits: "クレジット無制限・APIコスト削減",
    howToSection: "使い方",
    howToStep1: "1. ウェブページで調べたい単語や文章を選択",
    howToStep2: "2. 表示されるポップアップで「辞書」または「翻訳」をタップ",
    howToStep3: "3. 結果が表示されたら「★ 単語帳へ」で保存（有料プラン）",
    howToStep4: "4. 設定タブから出力言語・UI言語・履歴件数を変更可能",
    howToTip: "ヒント: 出力言語を変えると、回答もその言語で返ってきます。BYOKプランなら自分のAPIキーで無制限利用できます。",
    saveSettings: "設定を保存",
  ...
  en: {
    ...
    historyFreeNote: "Free plan keeps 10 items. Upgrade to Pro to extend up to 50 items.",
    historyPaidRequired: "20+ items requires Pro or higher. Please upgrade your plan.",
    planModalTitle: "Choose a plan",
    planSelectBtn: "Select",
    planFreeName: "Free",
    planFreeLimit: "Up to 10/day",
    planFreePrice: "$0/mo",
    planProLimit: "1,000 credits/month",
    planProPrice: "$3.20/mo",
    planProBenefits: "History save · Priority support",
    planProPlusName: "Pro+ (Recommended)",
    planProPlusLimit: "3,000 credits/month",
    planProPlusPrice: "$5.30/mo",
    planProPlusBenefits: "Faster · Priority support",
    planByokLimit: "Use your own API key",
    planByokPrice: "$1.10/mo",
    planByokBenefits: "Unlimited credits · Lower cost",
    howToSection: "How to use",
    howToStep1: "1. Select any word or text on a web page",
    howToStep2: "2. Tap \"Dictionary\" or \"Translate\" in the popup",
    howToStep3: "3. Save results to your vocabulary with \"★ Save\" (paid plan)",
    howToStep4: "4. Change output language, UI language, history limit in Settings",
    howToTip: "Tip: Change Output Language to receive answers in any language. BYOK plan unlocks unlimited use with your own key.",
